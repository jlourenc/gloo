...
func NewHybridUpstreamClient(
	...
	consulDiscoveryConfig *v1.Settings_ConsulUpstreamDiscoveryConfiguration,
	...
	if consulClient != nil {
		clientMap[sourceConsul] = consul.NewConsulUpstreamClient(consulClient, consulDiscoveryConfig)
	}
